...
export const P2pTransactions = ({ transactions }: {
    ...
    return <Card title="Recent Transactions">
        <div className="pt-2">
            {
                transactions.sort(sortDate).map(t => <div className={`shadow 2xl p-3 rounded  border-solid border-2 border-black flex justify-between my-3 ${(!t.isSent) ? "bg-green-100" : "bg-red-100"}`}>
